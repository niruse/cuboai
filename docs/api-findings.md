...
**Cameras tested:** CAMERA_ID_1 (Baby_1), CAMERA_ID_2 (Baby_2)
...
```json
{
  "data": [
    {
      "device_id": "CAMERA_ID_1",
      "dev_admin_id": "admin@CAMERA_ID_1",
      "dev_admin_pwd": "SECRET_PASSWORD",
  ...
  "profiles": [
    {
      "device_id": "CAMERA_ID_1",
      "user_id": "...",
      "profile": "{\"baby\": \"Baby_1\", \"birth\": \"2022-01-01\", \"avatar\": \"https://...\", \"gender\": 1}"
    }
  ],
  "report_settings": [
    {
